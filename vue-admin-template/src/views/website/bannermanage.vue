...
<script>
    ...
    import Vue from 'vue'
    import { get_banner, post_banner, patch_banner, delete_banner } from '@/api/website'
    ...
    export default {
        ...
        methods: {
            ...
            post_banner_data(data) {
                post_banner(data).then(response => {
                    const data = response.data
                    console.log(data)
            ...
            patch_banner_data(data) {
                patch_banner(data).then(response => {
                    const data = response.data
                    console.log(data)
            ...
            delete_banner_data(data) {
                delete_banner(data).then(response => {
                    const data = response.data
                    console.log(data)
