<template>
    <div class="app-container">
        ...
        <el-table
            ...
            <el-table-column prop="subject_name" label="课程名称(zh)" width="150"></el-table-column>
            <el-table-column prop="title_en" label="课程名称(en)" width="150"></el-table-column>
        ...
        <el-dialog
            ...
            <div>
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="110px" class="demo-ruleForm">
                    ...
                    <el-form-item label="课程名称(zh)" prop="subject_name">
                        <el-input v-model="ruleForm.subject_name"></el-input>
                    </el-form-item>
                    <el-form-item label="课程名称(en)" prop="title_en">
        ...
        <el-dialog
            ...
            <div>
                <el-form :model="ruleForm_patch" :rules="rules_patch" ref="ruleForm_patch" label-width="110px" class="demo-ruleForm">
                    ...
                    <el-form-item label="课程名称(zh)" prop="subject_name">
                        <el-input v-model="ruleForm_patch.subject_name"></el-input>
                    </el-form-item>
                    <el-form-item label="课程名称(en)" prop="title_en">
                        <el-input v-model="ruleForm_patch.title_en"></el-input>
                    </el-form-item>
                    <el-form-item label="内容" prop="content">
...
<script>
    ...
    import Vue from 'vue'
    import { get_tourdomestic, post_tourdomestic, patch_tourdomestic, delete_tourdomestic } from '@/api/website'

    export default {
        name: "tourdomestic_manage",
        data () {
            return {
                msg:'tourdomestic_manage',
                ...
                rules: {
                    ...
                    title_en: [
                        { required: true, message: '请输入英文课题名称', trigger: 'blur' }
                    ],
                    subject_name: [
        ...
        methods: {
            get_banner_data(pk,page,page_size) {
                get_tourdomestic(pk,page,page_size).then(response => {
            ...
            post_banner_data(data) {
                post_tourdomestic(data).then(response => {
                    const data = response.data
                    console.log(data)
            ...
            patch_banner_data(data) {
                patch_tourdomestic(data).then(response => {
                    const data = response.data
                    console.log(data)
            ...
            delete_banner_data(data) {
                delete_tourdomestic(data).then(response => {
                    const data = response.data
                    console.log(data)
            ...
            edit_data(row) {
                ...
                this.ruleForm_patch.title_en = row.title_en
                this.ruleForm_patch.subject_name = row.subject_name
